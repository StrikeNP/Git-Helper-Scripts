...
# ifdef CLUBB
# The following line was added in order to compile WRF-CLUBB correctly. The following line has to match 
# choise for "export CONFIGURE_SERIAL|export CONFIGURE_OPENMP|export CONFIGURE_MPIE made in WTF/*.wtf
cp custom_config_files/configure.wrf.intel64.serial.yellowstone.clubb.debug configure.wrf
#cp custom_config_files/configure.wrf.intel64.smpar.yellowstone.clubb.debug configure.wrf
#cp custom_config_files/configure.wrf.intel64.dmpar.yellowstone.clubb.debug configure.wrf
