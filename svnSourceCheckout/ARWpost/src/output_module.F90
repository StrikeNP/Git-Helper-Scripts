! $Id: output_module.F90 846 2017-02-07 05:11:43Z bmg2@uwm.edu $
...
#ifdef UWM_CHANGES
        ! Change the number of characters printed to the GrADS *.ctl file for
        ! the variable names from 10 to 25.
        WRITE(ctl_var_string(ivars),'(A,"  ",i4,"  0  ",A," (",A,")")') cname(1:25),nz,trim(cdesc),trim(cunits)
#else
